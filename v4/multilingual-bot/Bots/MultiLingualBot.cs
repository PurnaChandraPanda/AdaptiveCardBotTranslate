    ...
    public class MultiLingualBot : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            if (IsLanguageChangeRequested(turnContext.Activity.Text))
            {
                ...
                // send a test card in the selected language
        ...
        private static async Task SendAdaptiveCardAsync(ITurnContext turnContext, CancellationToken cancellationToken)
        {
            // Greet anyone that was not the target (recipient) of this message.
            // To learn more about Adaptive Cards, see https://aka.ms/msbot-adaptivecards for more details.
            var welcomeCard = CreateAdaptiveCardTest();
            var response = CreateResponse(turnContext.Activity, welcomeCard);
            await turnContext.SendActivityAsync(response, cancellationToken);
            await turnContext.SendActivityAsync(turnContext.Activity.CreateReply("This should also be in your chosen language"), cancellationToken);
        }
        ...
        // Load attachment from file.
        private static Attachment CreateAdaptiveCardTest()
        {
            // combine path for cross platform support
